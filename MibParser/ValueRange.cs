...
namespace Lextm.SharpSnmpLib.Mib
{
    public class ValueRange
    {
        ...
        public ValueRange(Symbol first, Symbol second)
        {
            ...
            {
                if (first.ToString().EndsWith("B", StringComparison.CurrentCultureIgnoreCase))
                {
                    // Binary number
                ...
                else if (first.ToString().EndsWith("H", StringComparison.CurrentCultureIgnoreCase)) //true, System.Globalization.CultureInfo.InvariantCulture))
                {
                    // Hex number
            ...
            if (second != null)
            {
                ...
                {
                    if (second.ToString().EndsWith("B", StringComparison.CurrentCultureIgnoreCase))// true, System.Globalization.CultureInfo.InvariantCulture))
                    {
                        // Binary number
                    ...
                    else if (second.ToString().EndsWith("H", StringComparison.CurrentCultureIgnoreCase)) //true, System.Globalization.CultureInfo.InvariantCulture))
                    {
                        // Hex number
